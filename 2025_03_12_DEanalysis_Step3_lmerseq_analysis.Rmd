...
```
  ...
  + `r nrow(m_tissue_DE) #3678` genes are significantly differentially expressed between male antenna and legs
...
```
  ...
  + `r nrow(f_tissue_DE) #3027` genes are significantly differentially expressed between female antenna and legs
...
```
  ...
  + `r nrow(antenna_DE) #2` genes are significantly differentially expressed between male and female antenna.
...
### Volcano plots
```{r volcanos together, fig.height=10, fig.width=6}
